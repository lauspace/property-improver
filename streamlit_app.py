...
with col1:
    ...
    st.image(image1_url, caption="Imagen 1", use_column_width=True)
...
with col1:
    ...
    st.image(image3_url, caption="Imagen 3", use_column_width=True)
...
with col2:
    ...
    st.image(image4_url, caption="Imagen 4", use_column_width=True)
